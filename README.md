# Redux React Movie CRUD

Explore the redux philosophy, creation of the redux store and using connect to link state and action to arbitrary components.
...
Will take a fairly complex application used to search a movie database and connect it to two different reducers through redux.  Will both connect existing state definitions and build entire reducer / redux pairings from scratch.
